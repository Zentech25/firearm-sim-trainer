        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <section className="glass-tile rounded-2xl p-4 space-y-3">
            ...
            <div className="space-y-3">
              ...
              {/* Terrain preview */}
              <div className="relative h-56 rounded-xl overflow-hidden border border-primary/30 bg-muted/20 shadow-lg shadow-primary/5 group">
                <img
                ...
                <div className="absolute inset-0 hud-grid opacity-20 mix-blend-overlay" />
                {/* 3D frame lines */}
                ...
                <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-background/70 backdrop-blur-md border border-primary/40">
                    <MapPin className="h-3.5 w-3.5 text-primary" />
                    <span className="text-xs font-mono uppercase tracking-wider text-foreground font-semibold">{terrain}</span>
                  </div>
                  <span className="flex items-center gap-1 text-[10px] font-mono text-status-online px-2 py-1 rounded-md bg-status-online/10 border border-status-online/30">
                    <span className="relative flex h-1.5 w-1.5">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-status-online opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-status-online"></span>
                    </span>
                    LIVE PREVIEW
                  </span>
                </div>
